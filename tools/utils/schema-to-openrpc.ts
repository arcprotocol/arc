...
// Paths
const OPENAPI_SCHEMA_PATH = path.join(__dirname, '../../spec/versions/v1.0/arc-openapi.yaml');
const OPENRPC_OUTPUT_PATH = path.join(__dirname, '../../spec/versions/v1.0/arc-openrpc.json');
